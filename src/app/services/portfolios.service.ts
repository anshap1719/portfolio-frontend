    ...
    this.items = [
      {
        ...
        image: `/assets/atsign.${this.supportsWebP ? 'webp' : 'png'}`,
        url: 'https://atsign.co',
      ...
      },
      {
        ...
        image: `/assets/healthgps.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/greatercommons.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/cactus.${this.supportsWebP ? 'webp' : 'png'}`,
        url: 'https://cactus.is',
      ...
      },
      {
        ...
        image: `/assets/adspark.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/compute-vision.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/gamoloco.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/adnut.${this.supportsWebP ? 'webp' : 'png'}`,
        url: 'https://adnut.com',
      ...
      },
      {
        ...
        image: `/assets/concerto.${this.supportsWebP ? 'webp' : 'png'}`,
        url: '',
      ...
      },
      {
        ...
        image: `/assets/redcontender.${this.supportsWebP ? 'webp' : 'png'}`,
      ...
      },
      {
        ...
        image: `/assets/sample-app.${this.supportsWebP ? 'webp' : 'png'}`,
